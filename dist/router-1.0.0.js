    ...
    Router.prototype = {
      ...
      */
      ...
      isActive: function(handlerName) {
        ...
        var targetHandler = [targetHandlerInfos.length - 1].name;
        ...
        // Slice handlerinfos...
        // Need to make a handlerInfos with all the shit
        // we know so far... plus all the prexisting states...
        //
        ...
        //var stubbedRecognizer = {
          //handlersFor: function() {
          //}
        //};

        var newState = intent.applyToState(state, this.recognizer, this.getHandler, false);

        for (i = 0; i <= index; ++i) {
          handlerInfo = newState.handlerInfos[i];
          if (!(handlerInfo instanceof ResolvedHandlerInfo)) {
            return false;
          }
        }
...
window.RouterJs = requireModule('router');
}(window));