define('router', ['exports', 'router/router'], function (exports, Router) {
...
define('router/handler-info', ['exports', 'router/utils', 'rsvp'], function (exports, utils, rsvp) {
  ...
  HandlerInfo.prototype = {
    ...
    resolve: function(shouldContinue, payload) {
      ...
      return rsvp.Promise.resolve(undefined, this.promiseLabel("Start handler"))
...
define('router/handler-info/factory', ['exports', 'router/handler-info/resolved-handler-info', 'router/handler-info/unresolved-handler-info-by-object', 'router/handler-info/unresolved-handler-info-by-param'], function (exports, ResolvedHandlerInfo, UnresolvedHandlerInfoByObject, UnresolvedHandlerInfoByParam) {
...
define('router/handler-info/resolved-handler-info', ['exports', 'router/handler-info', 'router/utils', 'rsvp'], function (exports, HandlerInfo, utils, rsvp) {
...
define('router/handler-info/unresolved-handler-info-by-object', ['exports', 'router/handler-info', 'router/utils', 'rsvp'], function (exports, HandlerInfo, utils, rsvp) {
...
define('router/handler-info/unresolved-handler-info-by-param', ['exports', 'router/handler-info', 'router/utils'], function (exports, HandlerInfo, utils) {
...
define('router/router', ['exports', 'route-recognizer', 'rsvp', 'router/utils', 'router/transition-state', 'router/transition', 'router/transition-intent/named-transition-intent', 'router/transition-intent/url-transition-intent'], function (exports, RouteRecognizer, rsvp, utils, TransitionState, ___transition, NamedTransitionIntent, URLTransitionIntent) {
  ...
  function Router(_options) {
    ...
    this.recognizer = new RouteRecognizer['default']();
    this.reset();
  }
  ...
  function getTransitionByIntent(intent, isIntermediate) {
    ...
    if (handlerInfosEqual(newState.handlerInfos, oldState.handlerInfos)) {
      ...
      return this.activeTransition || new ___transition.Transition(this);
    }
    ...
    newTransition = new ___transition.Transition(this, intent, newState);
  ...
  Router.prototype = {
    ...
    */
    ...
    queryParamsTransition: function(changelist, wasTransitioning, oldState, newState) {
      ...
      if (!wasTransitioning && this.activeTransition) {
        ...
        var newTransition = new ___transition.Transition(this);
    ...
    transitionByIntent: function(intent, isIntermediate) {
      try {
        ...
        return new ___transition.Transition(this, intent, null, e);
      }
    },
    ...
    */
    reset: function() {
      ...
      this.state = new TransitionState['default']();
    ...
    */
    ...
    refresh: function(pivotHandler) {
      ...
      var intent = new NamedTransitionIntent['default']({
    ...
    */
    generate: function(handlerName) {
      ...
      var intent = new NamedTransitionIntent['default']({ name: handlerName, contexts: suppliedParams });
    ...
    isActiveIntent: function(handlerName, contexts, queryParams, _state) {
      ...
      var testState = new TransitionState['default']();
  ...
  */
  function handlerEnteredOrUpdated(currentHandlerInfos, handlerInfo, enter, transition) {
    ...
    if (transition && transition.isAborted) {
      throw new ___transition.TransitionAborted();
    }
  ...
  function finalizeTransition(transition, newState) {
    ...
    try {
      ...
      if (transition.isAborted) {
        ...
        return rsvp.Promise.reject(___transition.logAbort(transition));
      }
      ...
      if (!((e instanceof ___transition.TransitionAborted))) {
  ...
  */
  function doTransition(router, args, isIntermediate) {
    ...
    if (args.length === 0) {
      ...
      intent = new NamedTransitionIntent['default']({
        name: handlerInfos[handlerInfos.length - 1].name,
        contexts: [],
      ...
      intent = new URLTransitionIntent['default']({ url: name });
...
define('router/transition-intent', ['exports', 'router/utils'], function (exports, utils) {
...
define('router/transition-intent/named-transition-intent', ['exports', 'router/transition-intent', 'router/transition-state', 'router/handler-info/factory', 'router/utils'], function (exports, TransitionIntent, TransitionState, handlerInfoFactory, utils) {
...
define('router/transition-intent/url-transition-intent', ['exports', 'router/transition-intent', 'router/transition-state', 'router/handler-info/factory', 'router/utils', 'router/unrecognized-url-error'], function (exports, TransitionIntent, TransitionState, handlerInfoFactory, utils, UnrecognizedURLError) {
  ...
  exports['default'] = utils.subclass(TransitionIntent['default'], {
    ...
    applyToState: function(oldState, recognizer, getHandler) {
      ...
      if (!results) {
        throw new UnrecognizedURLError['default'](this.url);
      }
...
define('router/transition-state', ['exports', 'router/utils', 'rsvp'], function (exports, utils, rsvp) {
...
define('router/transition', ['exports', 'rsvp', 'router/utils'], function (exports, rsvp, utils) {
  ...
  function Transition(router, intent, state, error) {
    ...
    function checkForAbort() {
      if (transition.isAborted) {
        return rsvp.Promise.reject(undefined, utils.promiseLabel("Transition aborted - reject"));
      }
    }
  }
...
define('router/unrecognized-url-error', ['exports', 'router/utils'], function (exports, utils) {
  ...
  UnrecognizedURLError.prototype = utils.oCreate(Error.prototype);
