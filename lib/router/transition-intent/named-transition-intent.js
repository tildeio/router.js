...
var NamedTransitionIntent = subclass(TransitionIntent,
   ...
   *           Name of route handler
   *
   * @property {Array} contexts
   *           Objects passed for transition
   *
   * @property {Object} queryParams
   *           Dictionary of query parameters
   *
   * @property {Object} pivotHandler
   *           Handler object of the first handler to consider. This is used
   *           to refresh only part of the handler-stack.
   *
   * @property {TransitionState} preTransitionState
   *           Previously aborted transition-state holding the context objects
   *           for the named transition when retrying a transition.
   */ {
