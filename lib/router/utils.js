...
function callHook(obj, _hookName, arg1, arg2) {
  ...
  return obj[_hookName].call(obj, arg1, arg2);
}
...
function applyHook(obj, _hookName, args) {
  ...
  if (hookName) {
    if (args.length === 0) {
      return obj[_hookName].call(obj);
    } else if (args.length === 1) {
      return obj[_hookName].call(obj, args[0]);
    } else if (args.length === 2) {
      return obj[_hookName].call(obj, args[0], args[1]);
    } else {
      return obj[_hookName].apply(obj, args);
    }
  }
}
