...
function getTransitionByIntent(intent, isIntermediate) {
  var wasTransitioning = !!this.hasActiveTransition;
...
Router.prototype = {
  ...
  */
  ...
  queryParamsTransition: function(changelist, wasTransitioning, oldState, newState) {
    ...
    if (!wasTransitioning && this.hasActiveTransition) {
      // One of the handlers in queryParamsDidChange
      // caused a transition. Just return that transition.
      return this.activeTransition;
    } else if (!this.hasAbortedTransition) {
  ...
  */
  ...
  get hasActiveTransition() {
    return this.activeTransition && !this.activeTransition.isActive;
  },

  get hasAbortedTransition() {
    return this.activeTransition && !this.activeTransition.isAborted;
  },
