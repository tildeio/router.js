...
/**
 * @property {RouteRecognizer} recognizer Route-recognizer instance
 * @property {Object} delegate Forwards this delegate to the recognizer instance. Note: Needs to be set before a map() call!
 * @property {Transition} activeTransition Currently active transition. This will be set only during a transition.
 * @property {Function} didTransition({HandlerInfo[]}) Will be called when transition was finalized
 * @property {HandlerInfo[]} currentHandlerInfos List off entered and active HandlerInfo's
 * @property {TransitionState} state Current state of the router. This is set during the finalization of a transition, but might be already set at the beginning of the transition when intermediate is set.
 * @property {Function} getHandler Resolver for handler strings to objects
 * @property {Object} _changedQueryParams Dictionary of changed query parameters. Only has value during queryParamsDidChange event
 * @property {String} _willChangeContextEvent Name of the change context event. This can be used to change the identifier for this event.
