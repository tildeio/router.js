...
/**
 * Generated by named transitions for dynamic route segments
 *
 * @constructor
 * @extends HandlerInfo
 */
var UnresolvedHandlerInfoByObject = subclass(HandlerInfo,
  /** @lends UnresolvedHandlerInfoByObject.prototype */ {
  ...
  /**
    ...
    @param {Object} _model the model to be serialized for this handler
  */
