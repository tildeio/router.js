import { bind, merge, serialize, promiseLabel } from './utils';
...
/**
 * @property {String} name Name of the handler as given to the router
 * @property {Object} handler Resolved handler object through the router.getHandler() function
 * @property {Object} params Dictionary of parameters for the current handler.
 * @property {String[]} names Names of dynamic parameters from route-recognizer
 * @property {Array} context Model from handler or supplied with transitionTo()
 * @property {Function} factory Factory function used to create the current instance
 * @property {Boolean} isResolved Defines if this instance is a resolved instance
 * @property {Function} getModel ({Transition} transition) -> {*|Promise} Function to determine the handlers model.
 */
